...
namespace WinterJam.Screens
{
    internal class PauseScreen : Screen
    {
        ...
        private void DrawMenuButton(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.DrawString(GameSettings.GameFont, "MAIN MENU", textPosition, Color.Black);
        }
        ...
        private void DrawPlayButton(SpriteBatch spriteBatch)
        {
            ...
            Vector2 textPosition = Vector2.One;
            Vector2 textSize = GameSettings.GameFont.MeasureString("RESUME");
            ...
            spriteBatch.DrawString(GameSettings.GameFont, "RESUME", textPosition, Color.Black);
        }
    }
}
