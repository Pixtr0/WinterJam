...
namespace WinterJam
{
    ...
    public static class Score
    {
        ...
        {
            DrawScore(spriteBatch, position + new Vector2(240, 0));
        ...
        public static void DrawResults(SpriteBatch spriteBatch, Vector2 position)
        {
            position += new Vector2(100,100);
            DrawScore(spriteBatch, position + new Vector2(0,50));
            Vector2 textOffset = new Vector2(GameSettings.GameFont.MeasureString("Time Survived: " + ToString(0)).X / 2, 0);
            spriteBatch.DrawString(GameSettings.GameFont, "Time Survived: " + ToString(Time), position + new Vector2(1, 0) * GameSettings.Grid.ScaleFactor - textOffset, Color.White);
            spriteBatch.DrawString(GameSettings.GameFont, "Time Survived: " + ToString(Time), position + new Vector2(-1, 0) * GameSettings.Grid.ScaleFactor - textOffset, Color.White);
            spriteBatch.DrawString(GameSettings.GameFont, "Time Survived: " + ToString(Time), position + new Vector2(0, 1) * GameSettings.Grid.ScaleFactor - textOffset, Color.White);
            spriteBatch.DrawString(GameSettings.GameFont, "Time Survived: " + ToString(Time), position + new Vector2(0, -1) * GameSettings.Grid.ScaleFactor - textOffset, Color.White);
            spriteBatch.DrawString(GameSettings.GameFont, "Time Survived: " + ToString(Time), position - textOffset, Color.Black);
        }
