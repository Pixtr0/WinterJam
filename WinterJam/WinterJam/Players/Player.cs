...
namespace WinterJam.Players
{
    public class Player : GameObject
    {
        ...
        public void DrawEffect(SpriteBatch spriteBatch)
        {
            if (ShowSwingEffect)
            {
                spriteBatch.Draw(LastAnimationIndex < 4 ? GameSettings.SwingEffect : GameSettings.SwingEffect2, new Rectangle(EffectPossition.ToPoint(), EffectSize.ToPoint()), null, Color.White, 0, Vector2.Zero, IsFlipped ? SpriteEffects.FlipHorizontally : SpriteEffects.None, 0);
            }
        }
